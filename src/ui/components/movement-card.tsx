...
export function MovementCard({
  ...
  return (
    <div className="bg-primary-bg-color text-primary-text-color/60 shadow  rounded-2xl w-full h-full px-3 py-2 items-center">
      <div className="flex justify-start w-full h-full items-center gap-5">
        <ArrowUpRight
          className={`h-[45px] w-[45px] ${iconColor} p-2 rounded-lg transform ${iconRotation}`}
        />
