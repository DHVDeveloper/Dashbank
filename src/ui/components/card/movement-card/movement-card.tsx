...
export function MovementCard({
  ...
  return (
    <div className="bg-secondary-bg-color overflow-hidden transition-colors text-primary-text-color/60 shadow  rounded-2xl w-full h-full px-3 py-2 items-center">
      <div className="flex justify-start w-full h-full items-center gap-5">
        ...
        <div className="flex flex-col justify-center items-start">
          ...
          <div className={`text-2xl font-semibold truncate w-full text-start ${amountColor}`}>
            {formatMoney(money)}
          </div>
        </div>
      </div>
