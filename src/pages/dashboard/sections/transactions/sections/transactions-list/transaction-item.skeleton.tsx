export function TransactionItemSkeleton() {
  return (
    <div className="flex flex-col gap-5 bg-secondary-bg-color shadow items-center p-3 rounded-lg hover:bg-gray-50 sm:flex-row sm:p-4 animate-pulse">
      <div className="flex flex-1 w-full flex-col gap-4 items-start md:items-center md:flex-row sm:w-auto">
        ...
        <div className="h-4 w-full max-w-[300px] bg-gray-200 rounded"></div>
      </div>
